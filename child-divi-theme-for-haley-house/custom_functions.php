...
/**
 * Enqueues Custom people gallery scripts
 *
 */
function hh_custom_gallery() {
    if (is_page('people')) :
	wp_enqueue_script(
		'hh_custom_gallery',
		get_stylesheet_directory_uri() . '/hh-custom-gallery.js',
		array( 'jquery' )
	);

    endif;
}
add_action( 'wp_enqueue_scripts', 'hh_custom_gallery' );
